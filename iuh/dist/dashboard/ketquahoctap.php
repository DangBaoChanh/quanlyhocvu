      ...
      <div class="row">
        <div class="col-md-12 col-xl-8">
          <div class="d-flex align-items-center justify-content-between mb-3">
            <h5 class="mb-0">Kết quả học tập</h5>
              ...
              <table id="reorder-events" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                  ...
                  while ($r = $tblSP->fetch_assoc()) {
                    ...
                    $id_hocphan = md5($r['id_hocphan']);
                    $idsv = md5($r['id_sinhvien']);
                    echo '<tr>
                    <td>' . $r["tenhocphan"] . '</td>
                    <td>' . $r["mahocphan"] . '</td>
                    <td><a href="chitiethoctap.php?sv=' . $_REQUEST['sv'] . '&idsv=' . $idsv . '' . '&id_hocphan=' . $id_hocphan . '&id=' . $user . '" class="pc-link">Xem</td>
                  </tr>';
                  }
                  ?><?php
                  ?>
