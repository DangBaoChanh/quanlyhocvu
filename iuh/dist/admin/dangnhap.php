...
error_reporting(0);
session_start();
if (isset($_SESSION['sinhvien']) || isset($_SESSION['giangvien'])) {
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-end mb-4">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Nhập mã admin" name="user">
                </div>
                <div class="form-group mb-3">
                ...
                <div class="d-grid mt-4">
                  ...
                  <br />
                  <button type="submit" class="btn btn-primary" name="btnSubmit" id="dangnhap">Login</button>
                </div>
              <?php
                } else {
