...
exit; 
  ...
  $idsv= $_SESSION['sinhvien'];
  $user=$_REQUEST['sv'];
  $tblSP = $p->ThongtinUSER($user);
  $r = $tblSP->fetch_assoc();
?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-xxl-9">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <p class="mb-0">Xin chào, tên tôi là  <?php echo $r['tensinhvien'];?></p>
                        </div>
                      </div>
                      <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item px-0 pt-0">
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <p class="mb-0"> <?php echo $r['tensinhvien'];?></p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <li class="list-group-item px-0">
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <p class="mb-0"> <?php echo $r['hokhauthuongtru'];?></p>
                                </div>
                              </div>
                            </li>
                            <li class="list-group-item px-0">
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <p class="mb-0"> <?php echo $r['ngaysinh'];?></p>
                                </div>
                              </div>
                            </li>
                            ...
                            <div class="row">
                                ...
                                <p class="mb-0"> <?php echo $r['diachilienhe'];?></p>
                                </div>
                                <div class="col-md-6">
                                  <p class="mb-1 text-muted">Ngày cấp CCCD</p>
                                  <p class="mb-0"> <?php echo $r['ngaycap'];?></p>
                                </div>
                              </div>
                            </li>
                          </ul>
                          ...
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item px-0 pt-0">
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <p class="mb-0"> <?php echo $r['khoa'];?> </p>
                                </div>
                                <div class="col-md-6">
                                  <p class="mb-1 text-muted">Ngày vào trường</p>
                                  <p class="mb-0"> <?php echo $r['ngayvaotruong'];?></p>
                                </div>
                              </div>
                            </li>
                            <li class="list-group-item px-0">
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <p class="mb-0"> <?php echo $r['lopCN'];?></p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <li class="list-group-item px-0 pb-0">
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <p class="mb-1 text-muted">Chuyên ngành</p>
                                  <p class="mb-0"><?php echo $r['tenchuyennganh'];?></p>
                                </div>
                              </div>
                            </li>
                          </ul>
